...
bark_sound = pygame.mixer.Sound("Burger-dog/Sound/bark_sound.wav")
miss_sound = pygame.mixer.Sound("Burger-dog/Sound/miss_sound.wav")
pygame.mixer.music.load("Burger-dog/Sound/bd_background_music.wav")

#Set images
player_image_right = pygame.image.load("Burger-dog/Images/dog_right.png")
player_image_left = pygame.image.load("Burger-dog/Images/dog_left.png")
...
burger_image = pygame.image.load("Burger-dog/Images/burger.png")
